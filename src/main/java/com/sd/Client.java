        ...
        try {
            ...
            while (true) {
                ...
                if ("1".equals(op)) {
                    ...
                    if (!confirmacao.equalsIgnoreCase("s")) { System.out.println("[INFO] Operação cancelada."); continue; }
                } else if ("6".equals(op)) {
                    ...
                    try {
                        ...
                        if (val <= 0) { System.out.println("[ERRO] O valor deve ser maior que zero."); continue; }
                    } catch (NumberFormatException e) {
                        System.out.println("[ERRO] Formato inválido! Use ponto como separador decimal, ex: 52.30"); continue;
                    }
                ...
                String jsonEnvio = "";
                try {
                    jsonEnvio = mapper.writeValueAsString(mensagem);
